...
var server = new mongo.Server(config.dbHost || 'localhost', config.dbPort || '27017', serverOptions)
// server.allServerInstances().forEach(function (serverInstance) {
//  serverInstance.dbInstances = serverInstance.dbInstances || []
// })

var db = module.exports = new mongo.Db(config.dbName || 'floorplan', server, dbOptions)
