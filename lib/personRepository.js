...
var find = exports.find = function (query) {
  var cursor
  return Q.ninvoke(db.collection('people').find(query))
...
exports.findOne = function (id) {
  return Q.ninvoke(db.collection('people').findOne({ _id: OID(id) }))
}
...
exports.save = function (attrs) {
  ...
  delete attrs._id
  return Q.ninvoke(db.collection('people').update({ _id: id }, attrs, { upsert: true }))
...
exports.remove = function (id) {
  ...
  return exports.findOne(id)
    .then(function (person_) {
      person = person_
      return Q.ninvoke(db.collection('people_deleted').insert(person))
    })
    .then(function () {
      return Q.ninvoke(db.collection('people').remove(person))
    })
}
