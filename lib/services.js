...
function exportNodeData (req, res, next) {
...
// Render floorplan
function renderFloorplan (req, res, next) {
...
const people = {
  async find (params) { return database.findPeople(null) },
  async get (id, params) { return database.findPeople(id) },
  async create (data, params) { database.savePeople(data) },
  async update (id, data, params) { database.savePeople(data) },
  async patch (id, data, params) {},
  async remove (id, params) { database.deletePeople(id) },
  setup (app, path) {}
}
