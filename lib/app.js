...
app.configure(express.rest())
  ...
  .use(require('connect-slashes')(false, global.mountPoint))
  .use('/test', services.test) // basic test
...
server.on('listening', () => {
  const goneLive = 'Feathers/Express app active on port ' + global.wwwPort + ' , expecting callback on webpages to ' + global.mountPoint
