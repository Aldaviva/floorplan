...
app.configure(express.rest())
  ...
  .get('/endpoints', (req, res, next) => { res.json({ message: 'true' }) }) // this used to be some Storm thing
  .get('/endpoints/status', (req, res, next) => { res.json({ message: 'true' }) }) // this used to be some Storm thing
